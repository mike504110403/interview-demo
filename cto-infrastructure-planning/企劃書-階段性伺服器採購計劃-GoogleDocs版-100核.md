...
採用「地端逐步擴充 + 雲端彈性補充」混合策略。首次投資 45-50 萬元（1 台伺服器 + 雲端資源），12 個月內分四階段完成 4 台地端伺服器部署，總投資 160-172 萬元。

**方案 B：穩健成長（地端優先）**

採用「先建立基礎，按需擴充」策略。首次投資 80 萬元同時採購 2 台伺服器，立即建立基礎高可用架構，9 個月內完成 4 台部署，總投資 160 萬元。

#### 2.2 方案對比總表

| 比較項目 | 方案 0 | 方案 A | 方案 B |
|---------|--------|--------|--------|
| 最終架構 | 碎片化 | 4台統一架構 | 4台統一架構 |
| 高可用能力 | 無 | 完整（4節點）| 完整（4節點）|
| 12個月總投資 | 0-20萬 | 160-172萬 | 160萬 |
| 首次投資 | 0萬 | 45-50萬 | 80萬 |
...
| 方案 A | 80-85萬 | 12-18萬 | - | 92-103萬 |
| 方案 B | 120萬 | 3-4萬 | - | 123-124萬 |
...
| Phase 2 | 3-5月 | 38-40萬 | 83-90萬 | 2台，基礎HA | 2/4 |
| Phase 3 | 6-8月 | 38-40萬 | 121-130萬 | 3台，擴展容量 | 3/4 |
| Phase 4 | 9-12月 | 38-40萬 | 159-170萬 | 4台，完整HA，統一架構 | 4/4 完成 |

#### 4.2 時程甘特圖

**方案 A 執行時程（12個月）**

| 階段 | 1月 | 2月 | 3月 | 4月 | 5月 | 6月 | 7月 | 8月 | 9月 | 10月 | 11月 | 12月 |
|------|-----|-----|-----|-----|-----|-----|-----|-----|-----|------|------|------|
| Phase 1 | ■■ | ■■ | | | | | | | | | | |
| 賽事上線 | | ▲ | | | | | | | | | | |
| Phase 2 | | | ■ | ■ | ■ | | | | | | | |
...
|------|------|------|------|------|---------|---------|
| Phase 1 | 1-2月 | 80萬 | 80萬 | 2台，基礎HA | 2/4 | - |
| Phase 2 | 3-5月 | 40萬 | 120萬 | 3台，擴展 | 3/4 | 直播上線 |
| Phase 3 | 6-9月 | 40萬 | 160萬 | 4台，完整HA，統一架構 | 4/4 完成 | 業務增長或生產需求 |

#### 5.2 時程甘特圖

**方案 B 執行時程（9個月）**

| 階段 | 1月 | 2月 | 3月 | 4月 | 5月 | 6月 | 7月 | 8月 | 9月 |
|------|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| Phase 1 | ■■ | ■■ | | | | | | | |
| 賽事上線 | | ▲ | | | | | | | |
| 基礎HA | | ▲ | | | | | | | |
...
1. **投資效益最優** - 總成本 160 萬，與方案 A 相當，但時程快且架構簡單，比方案 0 的長期損失節省超過 100 萬
...
8. **高性能CPU** - AMD EPYC 128核心，多核運算性能優異，適合容器化部署

**方案 A 的局限：**
- 雖然首次投資較低（45-50 萬），但總成本相當且時程較長
- 混合雲架構增加技術複雜度，需要額外學習與管理成本
- 雲端月費持續支出，12 個月累計 8-12 萬元
...
#### 附件 A：伺服器規格建議（方案 A/B 適用）

**推薦配置（Phase 1-4 統一規格）**

| 規格項目 | 配置 |
|---------|------|
| 品牌型號 | Dell PowerEdge R750xa / HP ProLiant DL385 Gen10+ |
| CPU | AMD EPYC 7713 (64C/128T) × 2 = 128 cores |
| RAM | 300GB DDR4-3200 ECC（可擴展至 2TB）|
| 儲存 | 系統：2×960GB SSD RAID1 / 數據：10×1TB SSD RAID6（實際可用≈8TB）|
| 網路 | 雙 25GbE SFP28 冗餘（或雙 10GbE）|
| 電源 | 雙 1100W 80 Plus 白金 熱插拔 |
| 保固 | 3年 ProSupport 7×24 次日到府 |
| 單價 | 40 萬 TWD |

**4 台伺服器總資源容量**
- CPU: 512 cores（128×4）
- Memory: 1200 GB（300×4）
- Storage: 128 TB
...
|------|-----|--------|---------|------|
| Video（dev/stg/prd）| 80-120 cores | 150-200 GB | 20-30 TB | 三條產品線 |
| 賽事（dev/stg/prd）| 60-80 cores | 120-160 GB | 15-20 TB | 完整生命週期 |
| 直播（dev/stg/prd）| 80-120 cores | 150-200 GB | 20-30 TB | 含白產生產 |
| 基礎設施 | 40-50 cores | 80-100 GB | 10-15 TB | VPN/網路/監控 |
| K8s overhead | 30-40 cores | 60-80 GB | 5-10 TB | 系統保留 |
| 預留未來 | 100-150 cores | 200-300 GB | 30-50 TB | 擴展空間 |
